...
const Bid = () => {
    ...
    return (
        <div className=' bg-white p-6 border justify-between flex-col flex box_shadow rounded'>
            ...
            <div className='flex items-center gap-2  mb-4 text-end text-base font-medium text-buyer-second_know_more capitalize'>
                <a href="/" className='  font-semibold'>Know more</a>
                <MdOutlineArrowDropDown onClick={show} className={`cursor-pointer ${know_more && 'rotate-180'}`} size={22} />
            </div>
