...
function Form() {
	...
	const FormTitles = ["Sign Up", "Create Account", "Company Info.", "About Company"];
			...
			<div className="flex justify-center ">
				<div className="flex bg-white w-3/5 h-[520px] mt-28 rounded-md shadow-md">
					...
					<div className="flex flex-col justify-center w-8/12 p-3">
						...
						<p className='mb-5 text-center'>Enter you account details Or <a href="/" className='underline text-[#004AA1] font-medium'>Login</a></p>
						...
						<div className="flex justify-between w-3/5 text-center mx-auto mt-2">
							<button
								...
								className={`rounded-md p-2 text-white w-[100px] bg-[${page === 0 ? '#1672DE' : '#004AA1'}]`}
							>
								Previous
							</button>
						...
						<NavLink to={'/onboard'} className="text-[#004AA1] font-semibold underline text-center mt-1 text-lg">Become a Seller</NavLink>
					</div>
